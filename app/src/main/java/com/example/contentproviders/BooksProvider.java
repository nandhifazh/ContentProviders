...
public class BooksProvider extends ContentProvider {
    static final String PROVIDER_NAME = "com.android.provider.Books";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            Log.w("Provider database", "Upgrading database from version " + oldVersion + " to " + newVersion + ", which will destroy all old data");
...
//    arg2 = selectionArgs
        ...
        switch (uriMatcher.match(arg0)) {
            ...
            case BOOK_ID:
                ...
                count = booksDB.delete(
                        DATABASE_TABLE,
                        _ID + " = " + id + (!TextUtils.isEmpty(arg1) ? " AND (" + arg1 + ')' : ""), arg2
                );
                break;
